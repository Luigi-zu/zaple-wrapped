...
const WrappedViewer: React.FC<WrappedViewerProps> = ({ data, onRestart }) => {
  ...
  // Manejo de interacción unificado: Tap para navegar, Hold para pausar
  ...
  const handlePointerUp = (e: React.PointerEvent) => {
    ...
    // Si fue un toque rápido (menos de 250ms), navegamos
    if (duration < 250) {
      const { clientX } = e;
    ...
    <div className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden font-urbanist">
      ...
      >
        ...
        <div className="relative w-full h-full">
          ...
          {/* SLIDE 5: Stats Views (AJUSTADO TAMAÑO) */}
          <Slide isActive={currentSlide === 5}>
            <div className="flex flex-col items-center justify-center h-full text-center px-4 space-y-8">
               <div className="relative">
                  <motion.p initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8 }} className="text-[clamp(4.5rem,15vw,6rem)] font-jakarta font-black leading-none break-all">{formatNum(data.totalViews)}</motion.p>
          ...
          {/* SLIDE 7: Stats Comentarios (AJUSTADO TAMAÑO) */}
          <Slide isActive={currentSlide === 7}>
            <div className="flex flex-col items-center justify-center h-full text-center space-y-8 px-4">
              <div className="relative">
                <motion.p initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8 }} className="text-[clamp(6rem,20vw,9rem)] font-jakarta font-black leading-none">{formatNum(data.totalComments)}</motion.p>
          ...
          <Slide isActive={currentSlide === 8}>
            <div className="space-y-6 px-6">
              <motion.h2 {...titleAnim} className="text-2xl font-jakarta font-black uppercase tracking-tight">MUCHO <span className={G_KEYWORD}>APOYO ❤️</span></motion.h2>
          ...
          <Slide isActive={currentSlide === 9}>
            <div className="space-y-6 px-6">
              <motion.h2 {...titleAnim} className="text-2xl font-jakarta font-black uppercase tracking-tight">Y ALGUNOS <span className={G_KEYWORD}>QUE... 🤌🏻</span></motion.h2>
              <div className="space-y-4">
          ...
          <Slide isActive={currentSlide === 11}>
            <div className="text-center space-y-8">
               ...
               <motion.h2 {...titleAnim} className="text-4xl font-jakarta font-black leading-tight uppercase italic">TUS VIDEOS <br/><span className={G_KEYWORD}>MÁS VISTOS</span></motion.h2>
            </div>
          </Slide>
