...
const WrappedViewer: React.FC<WrappedViewerProps> = ({ data, onRestart }) => {
  ...
  // Manejo unificado de interacción
  const onPointerDown = () => {
  ...
  const onPointerUp = (e: React.PointerEvent) => {
    ...
    // Si duró menos de 200ms, es un toque para navegar
    if (duration < 200) {
      const { clientX } = e;
      const { innerWidth } = window;
      const threshold = innerWidth * 0.3; // 30% izquierdo para atrás
  ...
  // Added 'as const' to prevent TypeScript from widening 'ease' from a literal to 'string'
  const titleAnim = {
  ...
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden">
      <div className="relative w-full h-full max-w-[450px] bg-black overflow-hidden shadow-2xl touch-none">
        
        {/* Progress Bars */}
        <div className="absolute top-6 left-4 right-4 z-[130] flex gap-1 px-2">
            ...
            <div key={i} className="h-1 flex-1 bg-white/20 rounded-full overflow-hidden">
              <motion.div
                ...
                animate={{ 
                    ...
                    opacity: isPaused && i === currentSlide ? 0.3 : 1
                }}
        ...
        <div className="relative w-full h-full">
            ...
            <div className="relative h-full flex flex-col items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-lg font-urbanist text-[#89D0D4] font-bold mt-2 tracking-tight">Llegó tu Zaple Wrapped 2025</p>
                    </div>
                </motion.div>
            </div>
          </Slide>
          ...
          <Slide isActive={currentSlide === 1}>
            <div className="text-center space-y-6 px-10">
                <motion.div animate={{ scale: [1, 1.15, 1], rotate: [0, 5, -5, 0] }} transition={{ repeat: Infinity, duration: 4 }} className="text-8xl">✨</motion.div>
                <motion.h2 {...titleAnim} className="text-2xl font-jakarta font-extrabold leading-tight">
          ...
          <Slide isActive={currentSlide === 2}>
            <div className="text-center space-y-4">
                ...
                <motion.h2 {...titleAnim} className="text-4xl font-jakarta font-black italic uppercase">¡TRABAJASTE <br/><span className={G_KEYWORD}>DURO!</span></motion.h2>
            </div>
          </Slide>
              ...
              <div className="flex flex-col h-full pt-20 pb-10 space-y-4 px-4">
                <div className="relative flex-1 bg-black rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl">
                   ...
                   <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-[90%]">
                      <div className="grid grid-cols-3 gap-2 bg-black/70 backdrop-blur-2xl p-5 rounded-[2.2rem] border border-white/10">
                        <div className="text-center">
          ...
          <Slide isActive={currentSlide === 7}>
            <div className="text-center space-y-4">
                <div className="text-8xl mb-2">🚀</div>
                <motion.h2 {...titleAnim} className="text-4xl font-jakarta font-black italic uppercase">¡LLEGAMOS <br/><span className={G_KEYWORD}>LEJOS!</span></motion.h2>
            </div>
          </Slide>
          ...
          <Slide isActive={currentSlide === 8}>
            <div className="flex flex-col items-center justify-center h-full text-center px-4">
               <div className="relative z-10 space-y-6">
                  <motion.p initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 1 }} className="text-[clamp(4rem,15vw,6rem)] font-jakarta font-black leading-none">{formatNum(data.totalViews)}</motion.p>
                  <p className="text-lg font-urbanist font-bold text-[#46DEFF] tracking-[0.2em] uppercase">Vistas Totales</p>
                  <p className="text-xl font-urbanist italic text-gray-400 max-w-[280px] mx-auto mt-6 leading-tight">
          ...
          <Slide isActive={currentSlide === 9}>
            <div className="text-center space-y-4">
                <div className="text-8xl mb-2">💬</div>
                <motion.h2 {...titleAnim} className="text-4xl font-jakarta font-black italic uppercase leading-none">DISTE DE <br/><span className={G_KEYWORD}>QUÉ HABLAR</span></motion.h2>
            </div>
          </Slide>
          ...
          <Slide isActive={currentSlide === 10}>
            <div className="flex flex-col items-center justify-center h-full text-center space-y-10 px-4">
                <motion.p initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 1 }} className="text-[clamp(6rem,18vw,8rem)] font-jakarta font-black leading-none">{formatNum(data.totalComments)}</motion.p>
          ...
          <Slide isActive={currentSlide === 11}>
            <div className="space-y-5 px-6">
              <motion.h2 {...titleAnim} className="text-xl font-jakarta font-black uppercase tracking-tight ml-1">MUCHO <span className={G_KEYWORD}>APOYO ❤️</span></motion.h2>
          ...
          <Slide isActive={currentSlide === 12}>
            <div className="space-y-5 px-6">
              <motion.h2 {...titleAnim} className="text-xl font-jakarta font-black uppercase tracking-tight ml-1">Y ALGUNOS <span className={G_KEYWORD}>QUE... 🤌🏻</span></motion.h2>
              <div className="space-y-3">
          ...
          <Slide isActive={currentSlide === 13}>
            <div className="flex flex-col items-center justify-center text-center space-y-6">
               ...
               <p className="text-md text-gray-400 font-urbanist max-w-[240px]">La gente señaló con un corazón que les volaste la cabeza.</p>
            </div>
          </Slide>
          ...
          <Slide isActive={currentSlide === 14}>
            <div className="text-center space-y-6">
               ...
               <motion.h2 {...titleAnim} className="text-3xl font-jakarta font-extrabold leading-tight">Y esto es solo <br/><span className={G_KEYWORD}>el principio.</span></motion.h2>
            </div>
          </Slide>
          ...
          <Slide isActive={currentSlide === 15}>
            <div className="flex flex-col h-full justify-between pt-24 pb-12 px-6">
                ...
                <div className="bg-black rounded-[3.1rem] p-8 flex flex-col items-center">
                  ...
                  <div className="w-full space-y-4 py-4 border-y border-white/10">
                    <div className="flex justify-between items-center px-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Vistas</span>
                      <span className="font-black text-xl text-[#46DEFF]">{formatNum(data.totalViews)}</span>
                    </div>
                    <div className="flex justify-between items-center px-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Likes</span>
                      <span className="font-black text-xl text-[#FF00E5]">{formatNum(data.totalLikes)}</span>
                    </div>
                    <div className="flex justify-between items-center px-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Minutos</span>
                      <span className="font-black text-xl text-[#9A5BFF]">{formatNum(data.totalMinutes)}</span>
                    </div>
                    <div className="flex justify-between items-center px-1">
                      <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Videos</span>
                      <span className="font-black text-xl text-[#89D0D4]">{data.totalVideos}</span>
                    </div>
                  </div>
              ...
              <button 
                ...
                className="relative z-[100] w-full py-5 bg-white text-black font-jakarta font-black rounded-2xl flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl"
              >
