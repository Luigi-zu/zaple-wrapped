...
export const CLIENTS_DATA: Record<string, WrappedData> = {
  ...
  "Masnatta": {
    ...
    supportiveComments: [
      ...
      { id: "s3", username: "flor_etcheverry", text: "Que buen Post Melina! Para difundir!", profilePic: "/imagenes/comentarios/Meli 3.png" }
    ],
    weirdComments: [
  ...
  "Loidi": {
    ...
    supportiveComments: [
      ...
      { id: "s3_l", username: "un_exito93", text: "Gracias rey! Tengo admiración a tu forma de desenvolverte en un escenario. 🙌👏👏", profilePic: "/imagenes/comentarios/Jonatan 3.png" }
    ],
    weirdComments: [
  ...
  "Rieznik": {
    ...
    supportiveComments: [
      ...
      { id: "s3_rz", username: "rocio.mar.792", text: "Que bueno que divulgues incansablemente el conocimiento científico ❤️", profilePic: "/imagenes/comentarios/Andrés 3.png" }
    ],
    weirdComments: [
  ...
  "Zuchovicki": {
    ...
    supportiveComments: [
      ...
      { id: "s3_z", username: "veronica_viajera", text: "SOS un genio !!! Me encanta como explicas todo.. Gracias por compartir", profilePic: "/imagenes/comentarios/Claudio 3.png" }
    ],
    weirdComments: [
  ...
  "Tomi": {
    ...
    supportiveComments: [
      ...
      { id: "s3_c", username: "graciela_melga", text: "Qué lindo es escucharte siempre, Tomás. Tenes un discurso inspirador y esperanzador 🤗🤗🤗", profilePic: "/imagenes/comentarios/Tomi 3.png" }
    ],
    weirdComments: [
  ...
  "Patricia": {
    ...
    supportiveComments: [
      ...
      { id: "s3_j", username: "timotea_deco", text: "Siempre abriendo la mente @patriciajebsen 👏🙌 crack total!❤️", profilePic: "/imagenes/comentarios/Pato 3.png" }
    ],
    weirdComments: [
  ...
  "Melamed": {
    ...
    supportiveComments: [
      ...
      { id: "s3_m", username: "haydeeferreyra", text: "Ale , más claro , imposible ! Un grosso transformando equipos .", profilePic: "/imagenes/comentarios/Ale 3.png" }
    ],
    weirdComments: [
  ...
  "Cwaik": {
    ...
    supportiveComments: [
      ...
      { id: "s3_cw", username: "joancomunicador", text: "Joan sos un capó amigo 👏🏻👏🏻👏🏻👏🏻", profilePic: "/imagenes/comentarios/Joan 3.png" }
    ],
    weirdComments: [
  ...
  "Dubi": {
    ...
    supportiveComments: [
      ...
      { id: "s3_d", username: "eduardo_jmg", text: "Eres uno de los mejores hallazgos de mi 2025. Una genia. Gracias! Tus videos en YouTube son Oro!", profilePic: "/imagenes/comentarios/Caro 3.png" }
    ],
    weirdComments: [
  ...
  "Streamset": {
    ...
    supportiveComments: [
      ...
      { id: "s3_st", username: "calijh", text: "Uffff que punto tocaste Jonatan. #Había que decirlo no? 👏👏👏", profilePic: "/imagenes/comentarios/Streamset  3.png" }
    ],
    weirdComments: [
